...
func (in *KogitoServerlessBuildSpec) DeepCopyInto(out *KogitoServerlessBuildSpec) {
	*out = *in
	if in.SourceSwf != nil {
		in, out := &in.SourceSwf, &out.SourceSwf
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KogitoServerlessBuildSpec) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KogitoServerlessBuildStatus) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
